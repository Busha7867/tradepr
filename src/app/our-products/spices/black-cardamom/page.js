...
export default function BlackCardamon()  {
    return (
        <div>
            <Navbar />
...
export function generateMetadata({ params }) {
    return {
        title: "Black Cardamon Spices Exported from India | Trade-Pros",
        description: "Experience the richness of Black Cardamom with Trade Pros: Best Cardamom spices exporters in India. Your source for top black Cardamom and other Indian spices.",
        alternates: {
            canonical: `${"https://trade-pros.org/our-products/spices/black-cardamon/"}`,
        ...
        ogUrl: "https://trade-pros.org/our-products/spices/black-cardamon/",
