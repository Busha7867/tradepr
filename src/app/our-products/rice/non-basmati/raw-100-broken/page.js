...
import Green from '@/Components/Riceimages/RawBroken100.jpg';
...
export default function Raw100 () {
    return (
        <div>
            <Navbar/>
                ...
                <div className="container">
                    <div className="row">
                        ...
                        <div className="col-6 col-m-12 col-t-12">
                            ...
                            Raw 100% Broken is very famous in African Countries. This first-rate is eaten by most of the populace in a few Countries for its Good flavour and Cooking. The product is 100% damaged, cortex clean, double polished, silky white raw 100% broken.
