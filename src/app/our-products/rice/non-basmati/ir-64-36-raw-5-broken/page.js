...
import Green from '@/Components/IR5Broken.jpg';
...
export default function Rbroken() {
    return (
        <div>
                ...
                <div className="container">
                    <div className="row About_absou">
                        ...
                        <div className="col-8 col-m-12 col-t-12">
                            <div className="slugs">
                                <h1 className='About_head'>IR 64/36 Raw 5% Broken</h1>
                ...
                <div className="container">
                    <div className="row">
                        ...
                        <div className="col-6 col-m-12 col-t-12">
                            ...
                            IR 64/36 Raw 5% Broken</h2>
                            <p style={{ marginBottom: "2rem" }}>
                            IR 64/36 Raw 5% Broken is a form of Rice that is notably demanded in numerous international locations of the global, in particular, South Africa and its neighboring area. This is a medium-grain type of Rice; the duration of the grain is 6.00 to 6.85 mm.
