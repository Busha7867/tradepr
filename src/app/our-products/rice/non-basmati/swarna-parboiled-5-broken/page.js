...
export function generateMetadata({ params }) {
    return {
        title: "Swarna Parboiled 5% Broken Rice Suppliers in India",
        description: "Experience the unmatched quality of Swarna Parboiled 5% Broken Rice, expertly exported from India. Discover the perfect balance of flavor in every grain.",
        alternates: {
            canonical: `${"https://trade-pros.org/our-products/rice/non-basmati/swarna-parboiled-5-broken/"}`,
